...
protocol TreatmentsManager: Sendable {
    func getTreatment(flag: String, target: Target, evaluationOptions: EvaluationOptions?) async -> EvaluationResult
    func getTreatments(flags: [String], target: Target, evaluationOptions: EvaluationOptions?) async -> [EvaluationResult]
    func getTreatmentsByFlagSets(flagSets: [String], target: Target, evaluationOptions: EvaluationOptions?) async -> [EvaluationResult]
}
